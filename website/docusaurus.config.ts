...
const app_name: string = 'anthropic_compliance_app_for_splunk'.replaceAll("_", " ");
const repo_name: string = 'anthropic_compliance_app_for_splunk';
const app_descr: string = 'Anthropic Compliance App for Splunk';
